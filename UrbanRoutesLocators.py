...
class LocatorsUrbanRoutes:
    ...
    input_card_number_field = (By.XPATH, '//div[@class="card-number-input"]/input[@class="card-input"]')
    input_card_code_field = (By.XPATH, '//div[@class="card-code-input"]/input[@class="card-input"]')
    confirmation_add_card_button = (By.XPATH, '//div[@class="pp-buttons"]/button[@class="button full" and text()="Agregar"]')
    close_pm_button = (By.XPATH, '//div[@class="section active"]/div[@class="head" and text()="Método de pago"]/preceding-sibling::button[@class="close-button section-close"]')
